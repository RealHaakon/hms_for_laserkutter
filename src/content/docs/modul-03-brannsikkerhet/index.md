...
- Materialet under kutting tar fyr (flamme i stedet for smeltet kant)
...
- Brannslukkeren skal alltid være synlig og ikke blokkert
- Sjekk at trykkmåleren viser grønt (riktig trykk) før hver sesjon
- Aldri flytt brannslukkeren permanent fra plasseringen
...
- Sjekk at ventilasjonen fungerer før hver kjøring (se [Modul 5](/modul-05-ventilasjon/))
...
- [Modul 8 — Nødprosedyrer](/modul-08-nodprosedyrer/) for fullstendig nødplan
- [Modul 5 — Ventilasjon](/modul-05-ventilasjon/) for avgasshåndtering
