...
Gweike LC1390N er designet for kutting og gravering av **ikke-metalliske materialer**. Det er avgjørende å bruke riktige materialer — feil valg kan forårsake giftige gasser, brann eller skade på maskinen. Materialhyllen har en rekke godkjente materialer.
...
> **Tips:** Verdiene over er utgangspunkt for kryssfiner. Test alltid på et lite hjørne før du kutter hele prosjektet.

## Forbudte materialer — og hvorfor

| Materiale | Årsak til forbud |
|---|---|
| **PVC (polyvinylklorid)** | Kloravgass — svært helseskadelig, korroderer maskinen |
| **Vinyl** | Samme problem som PVC |
...
1. **Sjekk materialets datablad** — Se etter klorinnhold og giftige tilsetninger
